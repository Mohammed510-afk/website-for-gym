            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">الاشتراكات المنتهية</h2>

                    </div>
                    <center>
                    <a href="print_allEnd.php" class="btn btn-secondary pull-left" style="width: 5% ;"></i>طباعة</a>
                    <br><br><br><br>
                    <?php
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="delete.php?id='. $row['id'] .'" title="حذف مشترك" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
